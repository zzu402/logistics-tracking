; (function(factory) {
    ...
    var Pagination = function(element, options) {
        ...
        this.filling = function(index) {
			...
			html +='<span>共'+opts.totalData+'条</span>';
        ...
        this.eventBind = function() {
            ...
            $obj.on('input propertychange', '.' + opts.jumpIptCls,
            function() {
                var $this = $(this);
                var val = $this.val();
                var reg = /[^\d]/g;
                if (reg.test(val)) $this.val(val.replace(reg, '')); (parseInt(val) > pageCount) && $this.val(pageCount);
