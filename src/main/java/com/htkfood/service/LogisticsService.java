...
public interface LogisticsService {
	...
	void getErpStockInfo(String billNo,Map<String, Object>result)throws CommonException;
	
	
	void editDriver(Long logisticsId,Long driverId,String plate,String engineNo,String vehicleType,HttpServletRequest request)throws CommonException;
}
